    ...
    public class Widget : BaseObject
    {
        ...
        public void Render(RenderContext context)
        {
            ...
            if (ClipToBounds && !MyraEnvironment.DisableClipping)
            {
                ...
                var transformedView = ApplyTransform(context, view);
                var newScissorRectangle = Rectangle.Intersect(oldScissorRectangle, transformedView);
                ...
                //newScissorRectangle = ApplyTransform(context, newScissorRectangle);
        ...
        private static Rectangle ApplyTransform(RenderContext context, Rectangle rect)
        {
